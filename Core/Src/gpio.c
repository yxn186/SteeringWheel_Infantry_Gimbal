...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : CS2_GYRO_Pin */
  GPIO_InitStruct.Pin = CS2_GYRO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CS2_GYRO_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : CS1_ACCLE_Pin */
  GPIO_InitStruct.Pin = CS1_ACCLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CS1_ACCLE_GPIO_Port, &GPIO_InitStruct);
